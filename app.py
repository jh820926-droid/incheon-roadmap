# =====================================================================
# 2026 인천자립 주거로드맵 - 주거 안심 백과사전 (최종 완결판)
# 기획 및 총괄: 김정현 멘토 (인천자립지원전담기관)
# =====================================================================
...
# ---------------------------------------------------------------------
# [2단계] 초정밀 CSS 레이아웃 및 🖨️ PDF 인쇄 완벽 제어
# (글씨 깨짐, 줄바꿈, 인쇄 잘림 현상을 원천 차단하는 마법의 코드)
# ---------------------------------------------------------------------
st.markdown("""
<style>
/* 폰트 및 배경 기본 세팅 */
...
/* 제목 텍스트 강제 줄바꿈 방지 (단어가 찢어지는 현상 방지) */
.main-title { 
    font-size: 2.4rem; 
    color: #1A5276; 
    font-weight: 900; 
...
@media print {
    ...
    h3, h4, .card-title, .section-title {
...
# ---------------------------------------------------------------------
# [5단계] 실전 거주 생존 매뉴얼 텍스트 생성기
# (주의: 마크다운 오류 방지를 위해 HTML 태그 앞 띄어쓰기 절대 금지)
# ---------------------------------------------------------------------
...
<div class='card-title'>🗓️ 전세임대 재계약 및 행정 처리 완벽 매뉴얼</div>
<ul class='step-list'>
<li><b>재계약 주기와 한도:</b> 기본 2년 단위로 계약합니다. 자립준비청년은 무려 총 14회까지 갱신이 가능해서 <span class='highlight-blue'>최장 30년</span> 동안 쫓겨날 걱정 없이 안전하게 살 수 있어요.</li>
<li><b>재계약 서류 준비법:</b> 계약 만료 3개월 전에 LH에서 우편물이 날아옵니다. 이때 당황하지 말고 <b>신분증 사본, 주민등록등본(상세), 가족관계증명서(상세), 금융정보제공동의서</b>를 동봉해서 지정된 법무사 사무실로 등기우편을 보내면 끝납니다.</li>
<li><b>소득 초과 시 주의점:</b> 열심히 일해서 내 월급이 국가 기준을 초과하더라도 길거리로 당장 쫓겨나지는 않습니다. 대신 매달 내는 임대료(이자)가 <span class='highlight-red'>조금 오를(할증될) 수</span> 있으니, 이 부분은 미리 저축 예산에 반영해두는 게 좋아요.</li>
<li><b>도배/장판 무상 지원:</b> 처음 이사할 때 벽지나 장판이 너무 더럽고 낡았다면, 내 돈을 절대 쓰지 말고 LH에 <b>도배/장판 지원금(약 60만 원 한도)</b>을 신청하세요. 거주 기간 중 딱 1번 쓸 수 있는 소중한 혜택입니다.</li>
</ul>
</div>
<div class='emergency-box'>
<div class='card-title'>🚨 전세임대 거주 중 위기 발생 시 멘토의 행동 요령</div>
<ul class='step-list'>
<li><b>이자가 연체되었을 때:</b> 이자가 3개월 이상 밀리면 LH에서 집을 비워달라는 무서운 우편(내용증명)이 옵니다. 돈이 없다고 무서워서 전화를 피하면 절대 안 됩니다! 즉시 <b>LH 지역본부 담당자</b>에게 전화해서 <span class='highlight-red'>"제가 지금 사정이 너무 어려워서 그러는데 밀린 이자를 분할해서 내게 해주세요"</span>라고 부탁하세요. 갚을 의지만 보이면 LH는 강제로 내쫓지 않고 기다려 줍니다.</li>
<li><b>집이 망가졌을 때 수리 책임 공방:</b> 형광등 교체, 도어락 건전지 교체 같은 가벼운 소모품은 내가 내 돈으로 갈아야 합니다. 하지만 <b>보일러 고장, 천장 누수, 수도관 파열</b> 같은 집의 구조적인 큰 문제는 무조건 '집주인'이 수리 비용을 내야 합니다. 직접 집주인과 싸우지 말고 <b>계약했던 부동산 사장님</b>에게 전화해서 중재를 부탁하는 것이 가장 지혜롭습니다.</li>
<li><b>급하게 이사가고 싶을 때 (이주 절차):</b> 계약 기간 중간에 직장 문제로 급하게 이사해야 한다고 내 맘대로 이삿짐을 빼면 절대 안 됩니다! 최소 2~3개월 전에 LH에 <b>'이주 신청서'</b>를 제출해야만 보증금을 안전하게 돌려받고 다음 집으로 갈 수 있습니다.</li>
</ul>
</div>"""
    ...
    # 5-2. 매입임대 생존 매뉴얼
        ...
        content = """<div class='action-box'>
<div class='card-title'>🗓️ 매입임대 거주 및 재계약 완벽 매뉴얼</div>
<ul class='step-list'>
<li><b>재계약 주기와 한도:</b> 2년 단위로 계약하며, 무주택 요건만 계속 유지하면 <span class='highlight-blue'>최장 20년</span>까지 한 집에서 거주할 수 있습니다. LH가 곧 집주인이기 때문에 악덕 집주인 만나서 보증금 떼일 걱정이 아예 없습니다.</li>
<li><b>풀옵션 가전 혜택 활용기:</b> 매입임대 주택 중 '청년형'은 <b>냉장고, 세탁기, 에어컨, 책상</b> 등이 기본 옵션으로 들어있는 경우가 아주 많습니다. 처음 독립할 때 수백만 원에 달하는 가전제품 구매 비용을 아낄 수 있는 최고의 혜택입니다.</li>
<li><b>관리비 폭탄 주의:</b> 매입임대의 월세 자체는 주변 시세보다 엄청 저렴합니다. 하지만, 빌라 특성상 공동청소비, 엘리베이터 유지비 등 <b>공용 관리비(보통 3~7만 원)</b>가 별도로 매달 청구됩니다. 월세와 관리비, 그리고 공과금(가스, 전기)을 모두 합친 금액으로 주거 예산을 짜야 생활비 펑크를 막을 수 있습니다.</li>
</ul>
</div>
<div class='emergency-box'>
<div class='card-title'>🚨 매입임대 위기 발생 시 멘토의 조언</div>
<ul class='step-list'>
<li><b>월세가 연체되었을 때:</b> 자동이체 통장에 잔고가 없어 3회 이상 밀리면 퇴거 대상 명단에 오릅니다. 밀린 기간만큼 연체 이자도 붙습니다. 경고 문자가 오면 즉시 <b>LH 주거복지 지사 담당자</b>에게 연락해 언제까지 조금씩 갚겠다고 명확히 밝혀야 집을 지킬 수 있습니다.</li>
<li><b>집안 시설이 고장 났을 때:</b> 매입임대의 가장 큰 장점입니다. 집안 기본 시설(보일러, 기본 옵션 가전 등)이 고장 나면 맘고생 할 필요 없이 <b>'LH 유지보수 접수센터 (☎ 1600-1004)'</b>로 전화 한 통만 하세요. 접수하면 수리 기사님이 직접 방문해서 무료로 고쳐주십니다.</li>
<li><b>갑자기 방을 빼야 할 때 (중도 해약):</b> 다른 지역으로 취업해서 방을 빼야 한다면, 방을 비우기 최소 <b>1개월 전</b>에 LH 지사에 <b>'해약 신청서'</b>를 제출해야 합니다. 그래야 보증금을 제날짜에 정산받고 깔끔하게 나갈 수 있습니다.</li>
</ul>
</div>"""

    # 5-3. 아파트(건설/통합) 생존 매뉴얼
    else: 
        content = """<div class='action-box'>
<div class='card-title'>🗓️ 공공아파트(건설/통합) 생활 완벽 가이드</div>
<ul class='step-list'>
<li><b>거주 안정성 끝판왕:</b> 2년 단위로 갱신하며 소득 및 자산 요건만 잘 유지하면 <span class='highlight-blue'>최장 30년</span> 거주가 보장됩니다. 2년마다 겪어야 하는 지긋지긋한 이사 스트레스, 중개수수료를 완벽하게 없앨 수 있습니다.</li>
<li><b>아파트 관리비 주의:</b> 빌라나 오피스텔보다 경비실, 조경 등 공용 시설이 많아 <b>아파트 관리비(1인 가구 기준 10~15만 원 이상)</b>가 꽤 무겁게 나옵니다. 여름철 에어컨 누진세, 겨울철 난방비까지 합치면 주거비 지출이 커지니 관리비 예산 통장을 꼭 따로 만들어 두세요.</li>
<li><b>자동차 가액 절대 주의:</b> 아파트 거주 중에 차를 사게 된다면 매우 조심해야 합니다! <b>국가에서 정한 자동차 가액 기준(약 3,700만 원 선, 매년 변동됨)</b>을 넘는 비싼 차를 내 명의로 등록하면, 다음번 재계약 심사에서 탈락해서 집에서 쫓겨납니다. 중고차를 사더라도 차량 가액을 꼭 확인하세요.</li>
</ul>
</div>
<div class='emergency-box'>
<div class='card-title'>🚨 아파트 거주 시 절대 주의사항 (강제 퇴거 위험)</div>
<ul class='step-list'>
<li><b>불법 전대 절대 금지:</b> 내가 당첨된 아파트를 싼값에 다른 친구나 지인에게 몰래 월세를 받고 빌려주는 행위(불법 전대)는 심각한 범죄입니다. LH 불시 점검에 걸리면 <span class='highlight-red'>즉각 강제 퇴거 조치되며 향후 5년 이상 모든 국가 주택에 입주할 수 없습니다.</span></li>
<li><b>층간소음 및 이웃 분쟁:</b> 아파트는 수백 세대가 모여 사는 공동주택입니다. 위층이 시끄럽다고 빗자루로 천장을 치거나 직접 올라가서 얼굴 붉히며 싸우지 마세요. 문제가 생기면 1차적으로 <b>'아파트 관리사무소'</b>에 정식으로 중재를 요청하는 것이 가장 안전합니다.</li>
</ul>
</div>"""
    return content
...
지금 청약 통장이 없다는 것은, 훗날 국가가 시세의 반값으로 제공하는 깨끗한 새 아파트에 들어갈 기회를 내 발로 걷어차는 것과 같습니다. 남들보다 뒤처지기 전에 지금 당장 시작해야 합니다.<br>
<div class='action-box'>
<span class='highlight-blue'>당장 실천할 과제</span> <b>무조건 내일 신분증 챙겨서 은행으로 달려가세요!</b>
<ul class='step-list'>
<li>은행 창구에 가서 <b>'청년주택드림청약통장'</b>을 개설해 달라고 요구하세요. 일반 청약통장보다 이자율이 최대 4.5%로 매우 높습니다.</li>
<li>당장 수중에 여유 돈이 없다면 매달 딱 <span class='highlight-yellow'>2만 원</span>만 자동이체 해두세요. 공공임대 아파트에 들어갈 때는 통장에 돈이 얼마 있느냐보다 <b>'단 한 번도 밀리지 않고 꾸준히 낸 횟수'</b>가 당첨을 결정하는 아주 중요한 가산점이 됩니다.</li>
<li>군 복무를 앞두고 있거나 복무 중이라면, 군인 전용 적금과 연계하여 혜택을 늘릴 수 있으니 담당 멘토에게 꼭 물어보세요.</li>
</ul>
</div>
</div>"""
    else:
...
수많은 유혹을 이기고 매달 꾸준히 청약을 넣고 있는 당신을 진심으로 칭찬합니다! 이 성실함이 나중에 아파트 청약 경쟁에서 당신을 1순위로 만들어 줄 가장 강력하고 날카로운 무기가 될 것입니다.<br>
<div class='tip-box'>
<span class='highlight-yellow'>절대 명심할 꿀팁</span> <b>목돈이 급할 땐 해지 대신 '대출'을 활용하세요!</b><br>
살다 보면 갑자기 병원비가 필요하거나 보증금 때문에 급전이 절실해서 청약 통장을 깨고 싶은 아찔한 순간이 무조건 옵니다. 그때 <span class='highlight-red'>절대 해지버튼을 누르지 마세요!</span> 스마트폰 은행 앱에 들어가서 <b>'청약예금 담보대출'</b>을 신청하면, 내가 넣은 돈의 90%까지 아주 싼 이자로 은행에서 바로 빌릴 수 있습니다. 이렇게 하면 내 소중한 청약 가점(납입 횟수)은 지켜내고, 당장의 급한 불도 끌 수 있습니다.
</div>
</div>"""
...
<b>최고의 장점:</b> 현재 당신은 만 20세까지 1억이 넘는 전세지원금에 대한 이자가 <span class='highlight-blue'>'완전 무료(0원)'</span>인 인생 최고의 재무적 황금기에 있습니다. 숨만 쉬어도 돈이 굳는 이 귀한 시기를 그냥 흘려보내면 절대 안 됩니다.<br>
<div class='action-box'>
<span class='highlight-blue'>돈 모으기 미션</span> <b>만 22세를 대비한 강제 저축 플랜</b>
<ul class='step-list'>
<li><b>이자가 생기는 시점을 명심하세요:</b> 영원히 무료가 아닙니다. 만 22세 이후부터는 전세지원금(예: 1억)에 대해 연 1~2%의 이자가 발생합니다. 즉, 어느 날 갑자기 매달 8~16만 원의 이자 청구서가 날아오게 됩니다.</li>
<li><b>종잣돈 강제 생성기:</b> 주거비가 1원도 안 나가는 지금! 매월 <span class='highlight-yellow'>최소 20만 원 이상</span> 무조건 해지가 어려운 적금에 묶어두세요. 이렇게 5년만 모아도 원금이 1,200만 원이 넘습니다. 이 돈이 나중에 더 넓고 좋은 집으로 이사 갈 때 든든한 내 보증금이 되어줄 겁니다.</li>
</ul>
</div>
</div>"""
...
<b>주거 안정성 100%:</b> 보호가 종료된 후 5년 동안 주어지는 '임대료 50% 감면' 특례를 아주 지혜롭게 활용하고 계시네요. 덕분에 주변 친구들이 50만 원씩 월세를 내며 허덕일 때, 당신은 5~10만 원대의 저렴한 월세로 편안하게 미래를 준비하고 있을 겁니다.<br>
<div class='tip-box'>
...
<ul class='step-list'>
<li>당신에게는 대한민국에서 가장 강력하고 위력적인 주거 복지 혜택인 <b>'자립준비청년 1순위 자격'</b>이 있습니다. 보증금 단돈 100~200만 원이면 국가가 관리하는 안전하고 저렴한 집으로 들어갈 수 있습니다.</li>
...
# ---------------------------------------------------------------------
# [7단계] 미래 10년/20년/30년 생애주기 로드맵 텍스트 생성
# (어려운 수학 공식 완전 제거, 쉬운 비유 사용)
# ---------------------------------------------------------------------
...
<div class='action-box'>
<span class='highlight-blue'>핵심 기술</span> <b>어려운 수학 공식은 잊어라! 부동산 사장님을 내 편으로 만드는 마법의 멘트</b>
<p>LH는 우리 청년들이 전세사기를 당하지 않도록 집주인의 빚을 정말 깐깐하게 검사해요. 쉽게 비유하자면, <b>집값이 100원일 때 집주인의 빚과 내 보증금을 합친 돈이 90원을 넘어가면 "위험한 깡통 전세"로 판정</b>하고 계약을 원천 차단해 줍니다. 이걸 실무 용어로 '권리분석 90% 룰'이라고 불러요.</p>
<ul class='step-list'>
<li><b>어려운 계산은 패스!:</b> 우리가 굳이 머리 아프게 등기부등본을 떼보며 계산기를 두드릴 필요 없어요. 요즘 공인중개사 사장님들도 LH의 이 깐깐한 규칙을 다 알고 계시거든요.</li>
<li><b>부동산 제압 멘트:</b> 공인중개사 사무소 문을 열고 들어가서 기죽지 말고 딱 이렇게만 말씀하세요! <span class='highlight-blue'>"사장님, 저 LH 전세임대로 구해요. 권리분석 무조건 안전하게 통과할 수 있는 '융자(빚) 없는 깨끗한 집'만 보여주세요!"</span> 이렇게 당당하게 말하면 사장님도 헛걸음하기 싫어서 알아서 가장 안전한 집만 쏙쏙 골라 찾아주신답니다.</li>
</ul>
</div>
...
<p>매입임대는 1년에 네 번 정기 모집을 하는데, 경쟁률이 수십 대 일에 달할 정도로 인기가 폭발적입니다. 하지만 서류 심사에 떨어지거나 막상 계약 날 변심해서 계약을 포기하는 '빈집'들이 매주 쏟아져 나옵니다. 우리는 남들이 버린 이 황금 같은 빈집을 주워 담아야 합니다.</p>
<ul class='step-list'>
...
# ---------------------------------------------------------------------
# [8단계] 최종 리포트 출력 메인 로직 
# (Submit 버튼 클릭 시 방대한 리포트가 화면에 렌더링됨)
# ---------------------------------------------------------------------
if submit_btn:
...
👤 담당자 김정현 멘토 (☎ 070-7663-1153) 올림
    ...
    # ---------------------------------------------------------------------
    # [9단계] 🖨️ PDF 인쇄 실행 버튼 (화면에서는 보이고, 인쇄 시 자동 투명화)
    # ---------------------------------------------------------
    st.markdown("---")
    components.html(
        """
        <div class="print-btn-container" style="text-align: center; margin-top: 20px; font-family: 'Noto Sans KR', sans-serif;">
            ...
            <p style="color: #7F8C8D; font-size: 15px; margin-top: 20px; font-weight: bold;">
                👆 춤추는 집 요정을 누르면 백과사전 전체가 A4 규격으로 완벽하게 분할되어 출력(저장)됩니다!
            </p>
        </div>
        """,
        height=250
