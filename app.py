...
@media print {
    ...
    html, body, #root, .stApp, [data-testid="stAppViewContainer"], [data-testid="stMainBlockContainer"], [data-testid="stVerticalBlock"] {
        ...
        overflow: visible !important; display: block !important; position: static !important; background-color: white !important;
    }
    .page-break { page-break-before: always !important; display: block !important; height: 1px !important; border: none !important; margin: 0 !important; padding: 0 !important; }
...
# =====================================================================
# 5. 실전 거주 생존 매뉴얼 함수 (들여쓰기 완전 제거로 마크다운 오류 차단)
# =====================================================================
...
# =====================================================================
# 7. 미래 10년/20년/30년 생애주기 맞춤 로드맵 생성 (들여쓰기 완전 제거)
# =====================================================================
    ...
    components.html(
        ...
        <div style="text-align: center; margin-top: 20px; font-family: 'Noto Sans KR', sans-serif;">
            ...
            <p style="color: #7F8C8D; font-size: 15px; margin-top: 20px; font-weight: bold;">
                👆 위 춤추는 집 요정을 누르면 백과사전 전체가 A4 규격으로 완벽하게 자동 분할되어 출력(저장)됩니다!
            </p>
        </div>
        """,
        height=250
